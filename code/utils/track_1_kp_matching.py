...
def get_predictions(predictions_file, labels_df, comment_df):
    comment_df = comment_df[["comment_id", "topic", "stance"]]
...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        ...
        comment_df, kp_df, labels_df = load_kpm_data(gold_data_dir, subset=subset_name)

        merged_df = get_predictions(predictions_file, labels_df, comment_df)
